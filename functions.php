...
$thumbnailelement = "";
				...
				if ($attachments) {
					...
					$imagethumbnail = wp_get_attachment_image_src($attachment, 'full');
					$imag_alt = get_post_meta($attachment, '_wp_attachment_image_alt', true);
					$thumbnailelement .= "<div class='col-md-12 col-xl-12 thumb-card thumb-tooltip' data-toggle='tooltip' data-placement='bottom' title=''><span class='helper'></span><a class='thumbnail-image align-bottom' >" .  wp_get_attachment_image($attachment, 'full',"", array( "class" => " align-bottom" )) . "</a></div>";
					$loopcount++;
					}
				}
